...
Run the following in command on the terminal: `git clone https://github.com/tusharrgoel/tf-task.git`

### Move on to the repository

Run the following in command on the terminal: `cd tf-task`

### Install all Dependencies
  
Run the following in command on the terminal: `npm install`

Next we can run any of the below scripts
